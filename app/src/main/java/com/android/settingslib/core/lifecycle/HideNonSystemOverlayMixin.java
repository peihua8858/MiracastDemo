...
public class HideNonSystemOverlayMixin implements LifecycleObserver {
    ...
    public void onStart() {
        ...
        mActivity.getWindow().addSystemFlags(WindowManager.LayoutParams.SYSTEM_FLAG_HIDE_NON_SYSTEM_OVERLAY_WINDOWS);
    ...
    public void onStop() {
        ...
        attrs.privateFlags &= ~WindowManager.LayoutParams.SYSTEM_FLAG_HIDE_NON_SYSTEM_OVERLAY_WINDOWS;
